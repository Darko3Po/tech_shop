					...
					<div class="card-body">
						...
						<div class="row checkout-form">
							...
							<div class="col-md-6 mt-3">
								...
								<input type="text" class="form-control" value="{{ Auth::user()->address1 }}" name="address1" placeholder="Enter First Name">
							</div>
							<div class="col-md-6 mt-3">
								<label for="">Address 2</label>
								<input type="text" class="form-control" value="{{ Auth::user()->address2 }}" name="address2" placeholder="Enter First Name">
							</div>
							<div class="col-md-6 mt-3">
